...
exports.main = function(project_path) {
    ...
    MethodCollections.renameToIndexUnderTheDir(project_path, function(index_path) {
        //console.log("now index_path is:"+index_path);
        /* find the index file under the sub dir*/
        //console.log(filepath);
        var file_content = fs.readFileSync(index_path).toString();
        ...
        // fs.writeFile(index_path, after_cont, "utf-8", function(err) {
        //     if (err) {
        //         throw err;
        //     } else {
        //         /* 文件转码*/
        //         console.log("i am the index_path:" + index_path);
        //         console.log("write over");
        //         /* 不进行转码*/
        //         //ConvertCharset.main(index_path);
        //         /* 删除元信息 meta*/
        //         //DeleteMeta.main(index_path);
        //     }
        // });
        /* 从json中读取数据信息替换匹配文本*/
        ...
        /* 操作完成之后将内容重新写入文件*/
        fs.writeFile(index_path, file_content, "utf-8", function(err) {
            if (err) {
                throw err;
            } else {
                /* 文件转码*/
